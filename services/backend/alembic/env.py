...
# Make the application package importable (code lives under src/).
...
# Autogenerate can only see tables that have been imported here.
from app.features.user import user_models  # noqa: E402, F401
