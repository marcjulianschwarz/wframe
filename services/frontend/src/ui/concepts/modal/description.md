...
- Enter animation
  - slide
  - fade
  - pop (springy scale overshoot — the panel scales up past full size then settles, via a `cubic-bezier(0.34, 1.56, 0.64, 1)` easing). The backdrop fades in underneath.
- Layout variant
